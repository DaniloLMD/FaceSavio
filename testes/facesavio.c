...
int main(int argc, char *argv[]) {
	...
	gtk_builder_add_callback_symbols(
		...
		"on_postButton_clicked", 	G_CALLBACK(on_postButton_clicked),
		NULL
	);
	...
	const int qtd_posts = 0; //quantidade de posts a serem carregados
